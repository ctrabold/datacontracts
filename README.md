...
Example DataContracts based on the [Open Data Contract Standard](https://github.com/bitol-io/open-data-contract-standard) described [here](https://datacontract.com/).
...
# `urn:<resource-type>:<domain>:[<sub-domain>:]<dataproduct-name>`
# The `dataproduct-name` is most likely a database or schema name
id: orders-latest
info:
  title: Orders Latest
  # `version` follows semantic versioning
  # We recommend to keep versioning simple e.g. bump major versions on breaking changes
  version: 2.0.0
  description: |
    ...
    quality:
      ...
      - type: sql
        ...
        query: |
          ...
          FROM orders
        mustBeGreaterThan: 5
    # TBC This section might be obsolete due to https://github.com/datacontract/datacontract-cli/issues/628
    examples:
      - |
